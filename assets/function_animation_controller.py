...
def write_json_ac(filename_a, filename_b):
    ...
    level_a = file_data_a.get("minecraft:client_entity", []).get("description")
    level_b = file_data_b.get("minecraft:client_entity", []).get("description")
